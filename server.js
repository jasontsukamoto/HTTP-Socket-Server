...
var server = net.createServer(function(client) {
  ...
  client.on('data', function(data) {
    ...
    if (data.split(' ')[1] === '/') {
      ...
      client.write('HTTP/1.1 200 OK\nServer: Jason Server 1.0\nDate: ' + Date.now() + 'Content-Type: text/html; charset=utf-8\nContent-Length: ' + string.length + '\nConnection: keep-alive');
      client.write('\n\n' + string);
      // client.end();
    } else if (data.split(' ')[1] === '/hydrogen.html') {
      ...
      client.write('\n\n' + hydrogen);
      // client.end();
    } else if (data.split(' ')[1] === '/helium.html') {
      ...
      client.write('\n\n' + error);
      // client.end();
    } else if (data.split(' ')[1] === '/css/styles.css') {
